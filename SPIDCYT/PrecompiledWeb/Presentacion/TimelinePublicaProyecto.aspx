<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Vistas_TimelinePublica, App_Web_0uh1qx05" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var tg1 = $("#placement").timeline({
                ...
                "data_source": "/Presentacion/timelinePublicaProyeto.json"
            });
        ...
        <tr>
            <td class="TituloNoticia" align="center" style="width: 900px;">
                <asp:Label ID="lblProyecto"  runat="server" Font-Size="Large" 
                    Text="Secretaría de Promoción de Investigaciones en Ciencia y Tecnología - Proyectos" 
