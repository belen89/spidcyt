...
public class ExportarPDF
{
    ...
    /// <param name="url">url path del servidor</param>
    public static void generarDocumentoDesdeHTML(string infoEnHtml, string url) {
        string file = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".pdf";
        string html = "<html><head></head><body>" +
        "<img alt=\"Logo iText\" src=\""+url+"\" height=\"40px\" width=\"450px\">" +
         infoEnHtml +  "</body></html>";
